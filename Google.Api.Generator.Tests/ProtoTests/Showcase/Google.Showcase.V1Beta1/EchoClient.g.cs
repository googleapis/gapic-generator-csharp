...
namespace Google.Showcase.V1Beta1
{
    ...
    public sealed partial class EchoClientBuilder : gaxgrpc::ClientBuilderBase<EchoClient>
    {
        ...
        public EchoClientBuilder() : base(EchoClient.ServiceMetadata)
        {
        }
    ...
    public abstract partial class EchoClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Echo.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);

...
namespace Google.Showcase.V1Beta1
{
    ...
    internal static class GaxApiDescriptor
    {
        ...
        internal static gaxgrpc::ApiDescriptor ApiDescriptor { get; } = new gaxgrpc::ApiDescriptor("Google.Showcase.V1Beta1", gaxgrpc::GrpcTransports.Grpc, GetFileDescriptors);

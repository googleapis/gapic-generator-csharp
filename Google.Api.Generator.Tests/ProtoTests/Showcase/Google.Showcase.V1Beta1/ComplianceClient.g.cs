...
namespace Google.Showcase.V1Beta1
{
    ...
    public sealed partial class ComplianceClientBuilder : gaxgrpc::ClientBuilderBase<ComplianceClient>
    {
        ...
        public ComplianceClientBuilder()
        {
            UseJwtAccessWithScopes = ComplianceClient.UseJwtAccessWithScopes;
        }
        ...
        protected override string GetDefaultEndpoint() => ComplianceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => ComplianceClient.DefaultScopes;

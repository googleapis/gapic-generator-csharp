...
namespace Google.Showcase.V1Beta1
{
    ...
    public sealed partial class TestingClientBuilder : gaxgrpc::ClientBuilderBase<TestingClient>
    {
        ...
        public TestingClientBuilder()
        {
            UseJwtAccessWithScopes = TestingClient.UseJwtAccessWithScopes;
        }
        ...
        protected override string GetDefaultEndpoint() => TestingClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => TestingClient.DefaultScopes;

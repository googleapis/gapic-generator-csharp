...
namespace Google.Showcase.V1Beta1
{
    ...
    {
        /// <summary>
        /// <see cref="gsv::UserName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gsv::UserName UserName
        {
            get => string.IsNullOrEmpty(Name) ? null : gsv::UserName.Parse(Name, allowUnparsed: true);

...
namespace Google.Showcase.V1Beta1
{
    ...
    public sealed partial class SequenceServiceClientBuilder : gaxgrpc::ClientBuilderBase<SequenceServiceClient>
    {
        ...
        public SequenceServiceClientBuilder()
        {
            UseJwtAccessWithScopes = SequenceServiceClient.UseJwtAccessWithScopes;
        }
        ...
        protected override string GetDefaultEndpoint() => SequenceServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => SequenceServiceClient.DefaultScopes;

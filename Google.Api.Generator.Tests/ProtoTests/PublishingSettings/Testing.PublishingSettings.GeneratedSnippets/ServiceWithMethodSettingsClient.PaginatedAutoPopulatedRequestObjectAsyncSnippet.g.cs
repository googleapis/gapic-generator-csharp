...
{
    // [START unknown_generated_ServiceWithMethodSettings_PaginatedAutoPopulated_async]
    ...
    public sealed partial class GeneratedServiceWithMethodSettingsClientSnippets
    {
        ...
        public async Task PaginatedAutoPopulatedRequestObjectAsync()
        {
            ...
            await response.ForEachAsync((Response item) =>
            {
            ...
            await response.AsRawResponses().ForEachAsync((PaginatedResponse page) =>
            {
    ...
    // [END unknown_generated_ServiceWithMethodSettings_PaginatedAutoPopulated_async]
}

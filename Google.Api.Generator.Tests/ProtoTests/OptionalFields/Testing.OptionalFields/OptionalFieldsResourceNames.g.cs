...
using sys = System;
using to = Testing.OptionalFields;
...
namespace Testing.OptionalFields
{
    ...
    {
        /// <summary>
        /// <see cref="to::ResourceName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public to::ResourceName ResourceName
        {
            get => string.IsNullOrEmpty(Name) ? null : to::ResourceName.Parse(Name, allowUnparsed: true);

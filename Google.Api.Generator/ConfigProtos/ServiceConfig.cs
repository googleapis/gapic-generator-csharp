...
namespace Grpc.ServiceConfig {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      if (waitForReady_ != null) {
        _single_waitForReady_codec.WriteTagAndValue(ref output, WaitForReady);
      }
      if (timeout_ != null) {
        output.WriteRawTag(26);
        output.WriteMessage(Timeout);
      ...
      if (maxRequestMessageBytes_ != null) {
        _single_maxRequestMessageBytes_codec.WriteTagAndValue(ref output, MaxRequestMessageBytes);
      }
      if (maxResponseMessageBytes_ != null) {
        _single_maxResponseMessageBytes_codec.WriteTagAndValue(ref output, MaxResponseMessageBytes);
      }
      if (retryOrHedgingPolicyCase_ == RetryOrHedgingPolicyOneofCase.RetryPolicy) {
        output.WriteRawTag(50);
        output.WriteMessage(RetryPolicy);
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 18: {
            bool? value = _single_waitForReady_codec.Read(ref input);
            if (waitForReady_ == null || value != false) {
              WaitForReady = value;
            }
            break;
          ...
          case 34: {
            uint? value = _single_maxRequestMessageBytes_codec.Read(ref input);
            if (maxRequestMessageBytes_ == null || value != 0) {
              MaxRequestMessageBytes = value;
            }
            break;
          ...
          case 42: {
            uint? value = _single_maxResponseMessageBytes_codec.Read(ref input);
            if (maxResponseMessageBytes_ == null || value != 0) {
              MaxResponseMessageBytes = value;
            }
            break;
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          ...
          retryableStatusCodes_.WriteTo(ref output, _repeated_retryableStatusCodes_codec);
          if (_unknownFields != null) {
            _unknownFields.WriteTo(ref output);
          }
        }
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
          ...
          switch(tag) {
              ...
              case 42:
              case 40: {
                retryableStatusCodes_.AddEntriesFrom(ref input, _repeated_retryableStatusCodes_codec);
                break;
              }
            }
          }
      ...
      #endif
      {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          ...
          nonFatalStatusCodes_.WriteTo(ref output, _repeated_nonFatalStatusCodes_codec);
          if (_unknownFields != null) {
            _unknownFields.WriteTo(ref output);
          }
        }
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
          ...
          switch(tag) {
              ...
              case 26:
              case 24: {
                nonFatalStatusCodes_.AddEntriesFrom(ref input, _repeated_nonFatalStatusCodes_codec);
                break;
              }
            }
          }
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      childPolicy_.WriteTo(ref output, _repeated_childPolicy_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 10: {
            childPolicy_.AddEntriesFrom(ref input, _repeated_childPolicy_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      childPolicy_.WriteTo(ref output, _repeated_childPolicy_codec);
      fallbackPolicy_.WriteTo(ref output, _repeated_fallbackPolicy_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 26: {
            fallbackPolicy_.AddEntriesFrom(ref input, _repeated_fallbackPolicy_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      methodConfig_.WriteTo(ref output, _repeated_methodConfig_codec);
      if (retryThrottling_ != null) {
        output.WriteRawTag(26);
        output.WriteMessage(RetryThrottling);
      }
      loadBalancingConfig_.WriteTo(ref output, _repeated_loadBalancingConfig_codec);
      if (healthCheckConfig_ != null) {
        output.WriteRawTag(42);
        output.WriteMessage(HealthCheckConfig);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 18: {
            methodConfig_.AddEntriesFrom(ref input, _repeated_methodConfig_codec);
            break;
          }
          case 26: {
            if (retryThrottling_ == null) {
          ...
          case 34: {
            loadBalancingConfig_.AddEntriesFrom(ref input, _repeated_loadBalancingConfig_codec);
            break;
          }
          case 42: {
            if (healthCheckConfig_ == null) {
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          if (serviceName_ != null) {
            _single_serviceName_codec.WriteTagAndValue(ref output, ServiceName);
          }
          if (_unknownFields != null) {
            _unknownFields.WriteTo(ref output);
          }
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
          ...
          switch(tag) {
              default:
                ...
                break;
              case 10: {
                string value = _single_serviceName_codec.Read(ref input);
                if (serviceName_ == null || value != "") {
                  ServiceName = value;
                }
                break;
